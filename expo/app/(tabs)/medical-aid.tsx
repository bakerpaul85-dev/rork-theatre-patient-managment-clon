      ...
      try {
        ...
        if (isAvailable) {
          ...
          if (mailResult.status === 'sent') {
            ...
            Alert.alert('Form Saved', 'Medical Aid form was saved. You can resend the email from your forms list.', [
              { text: 'OK', onPress: () => router.push('/') },
            ]);
          }
        } else {
          console.log('Mail composer not available on this device');
          Alert.alert('Form Saved', 'Medical Aid form was saved. Mail composer is not available on this device.', [
            { text: 'OK', onPress: () => router.push('/') },
          ]);
        }
      } catch (emailError) {
